package com.rodrigovalim07.integrationtests.controller.cors.withjson;
...
public class PersonControllerCorsJsonTests extends AbstractIntegrationTest {
	...
	public void testCreateWithWrongOrigin() throws JsonMappingException, JsonProcessingException {
		...
		var content = given().spec(specification)
				.contentType(TestConfigs.CONTENT_TYPE_JSON)
					.header(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_VALIM)
					.body(person)
					.when()
					.post()
				.then()
