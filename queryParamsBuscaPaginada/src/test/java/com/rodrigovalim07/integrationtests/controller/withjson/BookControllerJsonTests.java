...
import com.rodrigovalim07.integrationtests.vo.wrappers.WrapperBookVO;
...
public class BookControllerJsonTests extends AbstractIntegrationTest {
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("{\"self\":{\"href\":\"http://localhost:8888/api/book/v1/12\"}}}"));
		assertTrue(content.contains("{\"self\":{\"href\":\"http://localhost:8888/api/book/v1/2\"}}}"));
		assertTrue(content.contains("{\"self\":{\"href\":\"http://localhost:8888/api/book/v1/15\"}}}"));
